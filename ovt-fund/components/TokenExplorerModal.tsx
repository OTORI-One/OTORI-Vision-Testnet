...
export default function TokenExplorerModal({ isOpen, onClose, tokenData }: TokenExplorerModalProps) {
                    ...
                    <div className="mt-4 grid grid-cols-2 gap-4">
                      ...
                      <div className="bg-gray-50 rounded-lg p-4">
                        ...
                        <p className={`text-sm ${profitLoss >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                          {profitLoss >= 0 ? '+' : ''}{new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(profitLoss)}
                        </p>
                      </div>
                    </div>
